...
desired_caps['appActivity'] = 'com.aixuetang.mobile.activities.LaunchActivity'
#微信
...
dd = webdriver.Remote('http://172.16.20.92:4724/wd/hub', desired_caps)
...
time.sleep(2)
dd.get_screenshot_as_file(r'/root/Desktop/123.png')
dd.find_element_by_id('com.aixuetang.online:id/et_password').send_keys('123456a~')
dd.get_screenshot_as_file(r'/root/Desktop/gege.png')
time.sleep(2)
